...
public abstract class AbstractFilesWindow extends AbstractL2Window {
	...
	public AbstractFilesWindow(String title, Image image) {
		super(SWT.SYSTEM_MODAL, title, 400, 200);
		try {
