...
public class BackupSettingsWindow extends AbstractL2Window {
	...
	public void createGUI() {
		...
		data = new GridData(SWT.NONE, SWT.FILL, true, true);
		...
		try {
			...
			if (p != null) {
				...
				language = language.indexOf(".lng") >= 0 ? language.substring(0,
						language.length() - 4) : language;// condition for DEFAULT LANGUAGE
