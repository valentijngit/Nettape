...
//	public static final String SEARCH_WINDOW_MESSAGE_BOX_TEXT_ONE_DOT = "messageBoxTextOneDot";
	...
	public static void setDefaultLanguageGeneral() {
		if (defaultLanguageGeneral.size() == 0) {
			...
			defaultLanguageGeneral.put(GENERAL_TEXT_MESSAGE_TITLE_ERROR, "ERROR");
			defaultLanguageGeneral.put(GENERAL_TEXT_MESSAGE_TITLE_INFO, "INFO");
			defaultLanguageGeneral.put(GENERAL_TEXT_MESSAGE_TITLE_WARNING, "WARNING");
			defaultLanguageGeneral.put(GENERAL_TEXT_MESSAGE_TITLE_QUESTION, "QUESTION");
			defaultLanguageGeneral.put(GENERAL_TEXT_MESSAGE_TITLE_WAITING, "WAITING");
	...
	public static void setDefaultLanguageMainWindow() {
		if (defaultLanguageMainWindow.size() == 0) {
			defaultLanguageMainWindow.put(MAIN_WINDOW_TEXT_TITLE, "Backup and Restore");
			defaultLanguageMainWindow.put(MAIN_WINDOW_TEXT_BUTTON_USER_ACCOUNT, "User account");
			defaultLanguageMainWindow.put(MAIN_WINDOW_TEXT_BUTTON_BACKUP_SET, "Backup Set");
			defaultLanguageMainWindow.put(MAIN_WINDOW_TEXT_BUTTON_SCHEDULE, "Schedule");
			defaultLanguageMainWindow.put(MAIN_WINDOW_TEXT_BUTTON_SETTINGS, "Settings");
			defaultLanguageMainWindow.put(MAIN_WINDOW_TEXT_BUTTON_REPORTS, "Reports");
			defaultLanguageMainWindow.put(MAIN_WINDOW_TEXT_BUTTON_BACKUP, "Backup");
			defaultLanguageMainWindow.put(MAIN_WINDOW_TEXT_BUTTON_RESTORE, "Restore");
	...
	public static void setDefaultLanguageSettingsWindow() {
		if (defaultLanguageSettingsWindow.size() == 0) {
			defaultLanguageSettingsWindow.put(SETTINGS_WINDOW_TEXT_TITLE, "Application Setings");
			defaultLanguage.put(KEY_SETTINGS_WINDOW, defaultLanguageSettingsWindow);
		}
	}
	...
	public static void setDefaultLanguageAdvancedBackupSourceWindow() {
		if (defaultLanguageOpenFileWindow.size() == 0) {
			...
			defaultLanguage.put(KEY_ADVANCED_BACKUP_SOURCE_WINDOW, defaultLanguageOpenFileWindow);
		}
	}
	...
	public static void setDefaultLanguageLanguageWindow() {
		if (defaultLanguageLanguageWindow.size() == 0) {
			...
			defaultLanguageLanguageWindow.put(LANGUAGE_WINDOW_TEXT_LANGUAGE_NAME, "Language name");
			...
			defaultLanguage.put(KEY_LANGUAGE_WINDOW, defaultLanguageLanguageWindow);
		}
	}

	public static void setDefaultLanguageUserProfileWindow() {
		if (defaultLanguageUserProfileWindow.size() == 0) {
			defaultLanguageUserProfileWindow.put(USER_PROFILE_WINDOW_TITLE, "User profile");
			...
			defaultLanguageUserProfileWindow.put(USER_PROFILE_WINDOW_GROUP_USER_INFORMATION_BUTTON_SAVE_PASSWORD,
					"Save password");
			defaultLanguageUserProfileWindow.put(USER_PROFILE_WINDOW_GROUP_CONTACT_TITLE, "Contact");
			...
			defaultLanguageUserProfileWindow.put(USER_PROFILE_WINDOW_GROUP_TIME_ZONE_TITLE,
					"Time Zone");
			defaultLanguage.put(KEY_USER_PROFILE_WINDOW, defaultLanguageUserProfileWindow);
		}
	}

	public static void setDefaultLanguageBackupScheduleWindow() {
		if (defaultLanguageBackupScheduleWindow.size() == 0) {
			defaultLanguageBackupScheduleWindow.put(BACKUP_SCHEDULE_WINDOW_TITLE, "Backup Schedule");
			...
			defaultLanguageBackupScheduleWindow.put(BACKUP_SCHEDULE_WINDOW_BUTTON_SUNDAY, "Sunday");
			defaultLanguageBackupScheduleWindow.put(BACKUP_SCHEDULE_WINDOW_BUTTON_MONDAY, "Monday");
			...
			defaultLanguageBackupScheduleWindow.put(BACKUP_SCHEDULE_WINDOW_BUTTON_THURSDAY,
					"Thursday");
			defaultLanguageBackupScheduleWindow.put(BACKUP_SCHEDULE_WINDOW_BUTTON_FRIDAY, "Friday");
			defaultLanguageBackupScheduleWindow.put(BACKUP_SCHEDULE_WINDOW_BUTTON_SATURDAY,
					"Saturday");
			defaultLanguageBackupScheduleWindow.put(BACKUP_SCHEDULE_WINDOW_GROUP_TIME, "Time");
			defaultLanguageBackupScheduleWindow.put(BACKUP_SCHEDULE_WINDOW_LABEL_START, "Start");
			defaultLanguageBackupScheduleWindow.put(BACKUP_SCHEDULE_WINDOW_LABEL_STOP, "Stop");
			defaultLanguageBackupScheduleWindow.put(BACKUP_SCHEDULE_WINDOW_BUTTON_ON_COMPLETION,
					"on completion (Full Backup)");
			defaultLanguageBackupScheduleWindow.put(BACKUP_SCHEDULE_WINDOW_BUTTON_AFTER, "after");
			defaultLanguageBackupScheduleWindow.put(BACKUP_SCHEDULE_WINDOW_LABEL_HOURS, "hour(s)");

			defaultLanguage.put(KEY_BACKUP_SCHEDULE_WINDOW, defaultLanguageBackupScheduleWindow);
		}
	}
	...
	public static void setDefaultLanguageBachupSourceWindow() {
		if (defaultLanguageBackupSourceWindow.size() == 0) {
			defaultLanguageBackupSourceWindow.put(BACKUP_SOURCE_WINDOW_TEXT_TITLE, "Backup Source");
			defaultLanguageBackupSourceWindow.put(BACKUP_SOURCE_WINDOW_BUTTON_ADVANCE, "Advanced");
			defaultLanguage.put(KEY_BACKUP_SOURCE_WINDOW, defaultLanguageBackupSourceWindow);
		}
	}
	...
	public static void setDefaultLanguageBachupSettingsWindow() {
		if (defaultLanguageBackupSettingsWindow.size() == 0) {
			...
			defaultLanguageBackupSettingsWindow.put(BACKUP_SETTINGS_WINDOW_BUTTON_CHANGE, "Change");
			...
			defaultLanguageBackupSettingsWindow.put(BACKUP_SETTINGS_WINDOW_BUTTON_BACKUP_FILE,
					"Backup File Permision");
			defaultLanguageBackupSettingsWindow.put(BACKUP_SETTINGS_WINDOW_MESSAGE_DELETE_LANGUAGE_QUESTION,
					"Do you really  want to delete this language?");
			defaultLanguageBackupSettingsWindow.put(BACKUP_SETTINGS_WINDOW_MESSAGE_DELETE_LANGUAGE_ERROR,
					"This language can not be deleted!");
			defaultLanguage.put(KEY_BACKUP_SETTINGS_WINDOW, defaultLanguageBackupSettingsWindow);
		}
	}
	...
	public static void setDefaultLanguageFilesWindow() {
		if (defaultLanguageFilesWindow.size() == 0) {
			...
			defaultLanguageFilesWindow.put(FILES_WINDOW_TABLE_MODIFIED, "Modified");
			defaultLanguageFilesWindow.put(FILES_WINDOW_COMBO_ITEMS, "Items per page");
	...
	public static void setDefaultLanguageChangePathWindow() {
		if (defaultLanguageChangePathWindow.size() == 0) {
			defaultLanguageChangePathWindow.put(CHANGE_PATH_WINDOW_TEXT_TITLE, "Change Path");
			...
			defaultLanguage.put(KEY_CHANGE_PATH_WINDOW, defaultLanguageChangePathWindow);
		}
	}

	public static void setDefaultLanguageRestoreWindow() {
		if (defaultLanguageRestoreWindow.size() == 0) {
			defaultLanguageRestoreWindow.put(RESTORE_WINDOW_TEXT_TITLE, "Restore");
			defaultLanguageRestoreWindow.put(RESTORE_WINDOW_BUTTON_SHOW_FILES,
					"Show files as of jobs");
			defaultLanguageRestoreWindow.put(RESTORE_WINDOW_BUTTON_SHOW_ALL_FILES, "Show all files");
			defaultLanguageRestoreWindow.put(RESTORE_WINDOW_BUTTON_FILTER, "Filter");
			defaultLanguageRestoreWindow.put(RESTORE_WINDOW_GROUP_RESTORE, "Restore file to");
			...
			defaultLanguageRestoreWindow.put(RESTORE_WINDOW_BUTTON_SEARCH, "Search");
			defaultLanguage.put(KEY_RESTORE_WINDOW, defaultLanguageRestoreWindow);
		}
	}
	...
	public static void setDefaultLanguageSearchWindow() {
		if (defaultLanguageSearchWindow.size() == 0) {
			...
			defaultLanguageSearchWindow.put(SEARCH_WINDOW_TEXT_LOOK_IN, "Look in");
			defaultLanguageSearchWindow.put(SEARCH_WINDOW_BUTTON_CHANGE, "Change");
			defaultLanguageSearchWindow.put(SEARCH_WINDOW_TEXT_PATTERN, "Pattern");
			defaultLanguageSearchWindow.put(SEARCH_WINDOW_COMBO_TYPE, "Type");
			defaultLanguageSearchWindow.put(SEARCH_WINDOW_COMBO_APPLY_TO, "Apply to");
			defaultLanguageSearchWindow.put(SEARCH_WINDOW_COMBO_TYPE_CONTAINS, "contains");
			defaultLanguageSearchWindow.put(SEARCH_WINDOW_COMBO_TYPE_EXACT, "exact");
			defaultLanguageSearchWindow.put(SEARCH_WINDOW_COMBO_TYPE_START_WITH, "starts with");
			defaultLanguageSearchWindow.put(SEARCH_WINDOW_COMBO_TYPE_ENDS_WITH, "ends with");
			defaultLanguageSearchWindow.put(SEARCH_WINDOW_COMBO_APPLY_TO_FILES_DIRECTORIES,
					"files and directories");
			defaultLanguageSearchWindow.put(SEARCH_WINDOW_COMBO_APPLY_TO_FILES, "files only");
			...
			defaultLanguageSearchWindow.put(SEARCH_WINDOW_BUTTON_SEARCH_SUB_FOLDERS,
					"Search subfolders");
			defaultLanguageSearchWindow.put(SEARCH_WINDOW_BUTTON_MATCH_CASE, "Match case");
			defaultLanguageSearchWindow.put(SEARCH_WINDOW_BUTTON_SEARCH, "Search");
...
//					"Pattern must have at least one [.].");
	...
	public static void setDefaultLanguageBackUpFilterWindow() {
		if (defaultLanguageBackUpFilterWindow.size() == 0) {
			defaultLanguageBackUpFilterWindow.put(BACKUP_FILTER_WINDOW_TEXT_TITLE, "Backup filters");
			defaultLanguageBackUpFilterWindow.put(BACKUP_FILTER_WINDOW_COMBO_APPLY_TO, "Apply to");
			...
			defaultLanguage.put(KEY_BACKUP_FILTER_WINDOW, defaultLanguageBackUpFilterWindow);
		}
	}
	...
	public static void setDefaultLanguageRestoreFilterWindow() {
		if (defaultLanguageRestoreFilterWindow.size() == 0) {
			...
			defaultLanguage.put(KEY_RESTORE_FILTER_WINDOW, defaultLanguageRestoreFilterWindow);
		}
	}
	...
	public static void setDefaultLanguageSelectDirectoryWindow() {
		if (defaultLanguageSelectDirectoryWindow.size() == 0) {
			defaultLanguageSelectDirectoryWindow.put(SELECT_DIRECTORY_WINDOW_TEXT_TITLE,
					"Select directory");
			defaultLanguage.put(KEY_SELECT_DIRECTORY_WINDOW, defaultLanguageSelectDirectoryWindow);
		}
	}
