...
public class AppImages {
	...
	public static Image getImageMisc(String imageKey) {
		if (AppImages.hashImagesMisc.get(imageKey) == null) {
			AppImages.hashImagesMisc.put(imageKey, AppImages.loadImage(AppImages.APP_ROOT
					+ File.separator + AppImages.IMAGES_DIR + File.separator + "misc"
					+ File.separator + imageKey));
		}
