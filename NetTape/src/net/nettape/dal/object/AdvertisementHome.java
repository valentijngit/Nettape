...
/**
 * Home object for domain model class Advertisement.
 * @see net.nettape.dal.object.Advertisement
 * @author Hibernate Tools
 */
public class AdvertisementHome {

    private static final Log log = LogFactory.getLog(AdvertisementHome.class);
    ...
    public void persist(Advertisement transientInstance) {
        log.debug("persisting Advertisement instance");
        try {
    ...
    public Advertisement merge(Advertisement detachedInstance) {
        ...
        try {
            Advertisement result = (Advertisement) sessionFactory.getCurrentSession()
    ...
    public Advertisement findById( java.lang.Integer id) {
        ...
        try {
            Advertisement instance = (Advertisement) sessionFactory.getCurrentSession()
                    .get("net.nettape.dal.object.Advertisement", id);
            if (instance==null) {
    ...
    public List findByExample(Advertisement instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("net.nettape.dal.object.Advertisement")
