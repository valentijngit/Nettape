 ...
 * @see net.nettape.dal.object.Schedule
 * @author Hibernate Tools
 */
public class ScheduleHome {

    private static final Log log = LogFactory.getLog(ScheduleHome.class);
    ...
    public void persist(Schedule transientInstance) {
    ...
    public Schedule merge(Schedule detachedInstance) {
        ...
        try {
            Schedule result = (Schedule) sessionFactory.getCurrentSession()
    ...
    public Schedule findById( java.lang.Integer id) {
        ...
        try {
            Schedule instance = (Schedule) sessionFactory.getCurrentSession()
                    .get("net.nettape.dal.object.Schedule", id);
            if (instance==null) {
    ...
    public List findByExample(Schedule instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("net.nettape.dal.object.Schedule")
