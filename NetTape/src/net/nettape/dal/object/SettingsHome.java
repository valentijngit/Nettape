 ...
 * @see net.nettape.dal.object.Settings
...
public class SettingsHome {
    ...
    public Settings merge(Settings detachedInstance) {
        ...
        try {
            Settings result = (Settings) sessionFactory.getCurrentSession()
    ...
    public Settings findById( java.lang.Integer id) {
        ...
        try {
            Settings instance = (Settings) sessionFactory.getCurrentSession()
                    .get("net.nettape.dal.object.Settings", id);
            if (instance==null) {
    ...
    public List findByExample(Settings instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("net.nettape.dal.object.Settings")
