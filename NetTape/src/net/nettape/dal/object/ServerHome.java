 ...
 * @see net.nettape.dal.object.Server
...
public class ServerHome {
    ...
    public Server merge(Server detachedInstance) {
        ...
        try {
            Server result = (Server) sessionFactory.getCurrentSession()
    ...
    public Server findById( java.lang.Integer id) {
        ...
        try {
            Server instance = (Server) sessionFactory.getCurrentSession()
                    .get("net.nettape.dal.object.Server", id);
            if (instance==null) {
    ...
    public List findByExample(Server instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("net.nettape.dal.object.Server")
