 ...
 * @see net.nettape.dal.object.Filter
...
public class FilterHome {
    ...
    public Filter merge(Filter detachedInstance) {
        ...
        try {
            Filter result = (Filter) sessionFactory.getCurrentSession()
    ...
    public Filter findById( java.lang.Integer id) {
        ...
        try {
            Filter instance = (Filter) sessionFactory.getCurrentSession()
                    .get("net.nettape.dal.object.Filter", id);
            if (instance==null) {
    ...
    public List findByExample(Filter instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("net.nettape.dal.object.Filter")
